...
func main() {
	...
	backupPhrase := "educate ginger truck gossip fly sure small outside shock giggle below theory oblige faint pretty erosion supply tattoo radio lemon artefact pride width ability galaxy"
	...
	copy(mdk[:], keyBytes)
	cwResponse, err := kmdClient.CreateWallet("wallet24", "testpassword", kmd.DefaultWalletDriver, mdk)
	if err != nil {
